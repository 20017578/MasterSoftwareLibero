...
A parte i nodi per descrivere caratteristiche e tipi istruzione e ai nodi di tipo <http://www.w3.org/ns/locn#Address> si userebbero nodi di due classi:
 ...
 - Una per le istituzioni principali, sedi di segreteria: il tipo di amministrazione definito dall'AgID? <http://spcdata.digitpa.gov.it/CategoriaAmministrazione/L6> ... forse non va bene, perch� non � concepito come una classe di oggetti...
