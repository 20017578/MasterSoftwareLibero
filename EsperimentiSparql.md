...
Si tenga conto che http://www.opengis.net/ont/geosparql#asWKT Ë in stato **deprecated**, inoltre la richiesta qui sopra trova la geometria solo se uno dei suoi punti Ë anche geometria *a sÈ*, con latitudine e longitudine esplicitati e non *nascosti* nel WKT&hellip; Questo certamente non Ë il modo pi˘ efficiente di estrarre geometrie da [OSM](http://www.openstreetmap.org/)&hellip;